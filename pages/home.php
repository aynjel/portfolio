    ...
    <div class="row">
        <div class="media service-card col-lg-6">
            <div class="service-icon">
                <img src="assets/resume_template/assets/images/001-target.svg" alt="target">
            </div>
        ...
        <div class="media service-card col-lg-6">
            <div class="service-icon">
                <img src="assets/resume_template/assets/images/003-idea.svg" alt="bulb">
            </div>
            <div class="media-body">
        ...
        <div class="media service-card col-lg-6">
            <div class="service-icon">
                <img src="assets/resume_template/assets/images/002-development.svg" alt="development">
            </div>
            <div class="media-body">
        ...
        <div class="media service-card col-lg-6">
            <div class="service-icon">
                <img src="assets/resume_template/assets/images/004-smartphone.svg" alt="smartphone">
            </div>
            <div class="media-body">
    ...
    <div id="testimonialCarousel" class="testimonial-carousel carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img src="assets/resume_template/assets/images/Profile.png" alt="profile" class="testimonial-img">
